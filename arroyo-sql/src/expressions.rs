...
impl TryFrom<(BuiltinScalarFunction, Vec<Expression>)> for StringFunction {
    ...
    fn try_from(value: (BuiltinScalarFunction, Vec<Expression>)) -> Result<Self> {
        ...
        if args.len() == 1 {
            match func {
                BuiltinScalarFunction::Ascii => {
                    return Ok(StringFunction::Ascii(Box::new(args.remove(0))))
                }
                BuiltinScalarFunction::BitLength => {
                    return Ok(StringFunction::BitLength(Box::new(args.remove(0))))
                }
                BuiltinScalarFunction::CharacterLength => {
                    return Ok(StringFunction::CharacterLength(Box::new(args.remove(0))))
                }
                BuiltinScalarFunction::Chr => {
                    return Ok(StringFunction::Chr(Box::new(args.remove(0))))
                }
                BuiltinScalarFunction::InitCap => {
                    return Ok(StringFunction::InitCap(Box::new(args.remove(0))))
                }
                BuiltinScalarFunction::Lower => {
                    return Ok(StringFunction::Lower(Box::new(args.remove(0))))
                }
                BuiltinScalarFunction::OctetLength => {
                    return Ok(StringFunction::OctetLength(Box::new(args.remove(0))))
                }
                BuiltinScalarFunction::Reverse => {
                    return Ok(StringFunction::Reverse(Box::new(args.remove(0))))
                }
                BuiltinScalarFunction::Btrim => {
                    return Ok(StringFunction::Btrim(Box::new(args.remove(0)), None))
                }
                BuiltinScalarFunction::Ltrim => {
                    return Ok(StringFunction::Ltrim(Box::new(args.remove(0)), None))
                }
                BuiltinScalarFunction::Rtrim => {
                    return Ok(StringFunction::Rtrim(Box::new(args.remove(0)), None))
                }
                BuiltinScalarFunction::Trim => {
                    return Ok(StringFunction::Trim(Box::new(args.remove(0)), None))
                }
                BuiltinScalarFunction::Upper => {
                    return Ok(StringFunction::Upper(Box::new(args.remove(0))))
                }
                _ => todo!(),
            };
        };
        if args.len() == 2 {
            match func {
                BuiltinScalarFunction::Btrim => {
                    return Ok(StringFunction::Btrim(
                        Box::new(args.remove(0)),
                        Some(Box::new(args.remove(0))),
                    ))
                }
                BuiltinScalarFunction::Left => {
                    return Ok(StringFunction::Left(
                        Box::new(args.remove(0)),
                        Box::new(args.remove(0)),
                    ))
                }
                BuiltinScalarFunction::Lpad => {
                    return Ok(StringFunction::Lpad(
                        Box::new(args.remove(0)),
                        Box::new(args.remove(0)),
                        None,
                    ))
                ...
                BuiltinScalarFunction::Ltrim => {
                    return Ok(StringFunction::Ltrim(
                        Box::new(args.remove(0)),
                        Some(Box::new(args.remove(0))),
                    ))
                }
                BuiltinScalarFunction::Repeat => {
                    return Ok(StringFunction::Repeat(
                        Box::new(args.remove(0)),
                        Box::new(args.remove(0)),
                    ))
                }
                BuiltinScalarFunction::Right => {
                    return Ok(StringFunction::Right(
                        Box::new(args.remove(0)),
                        Box::new(args.remove(0)),
                    ))
                }
                BuiltinScalarFunction::Rpad => {
                    return Ok(StringFunction::Rpad(
                        Box::new(args.remove(0)),
                        Box::new(args.remove(0)),
                        None,
                    ))
                ...
                BuiltinScalarFunction::Rtrim => {
                    return Ok(StringFunction::Rtrim(
                        Box::new(args.remove(0)),
                        Some(Box::new(args.remove(0))),
                    ))
                }
                BuiltinScalarFunction::StartsWith => {
                    return Ok(StringFunction::StartsWith(
                        Box::new(args.remove(0)),
                        Box::new(args.remove(0)),
                    ))
                }
                BuiltinScalarFunction::Strpos => {
                    return Ok(StringFunction::Strpos(
                        Box::new(args.remove(0)),
                        Box::new(args.remove(0)),
                    ))
                }
                BuiltinScalarFunction::Substr => {
                    return Ok(StringFunction::Substr(
                        Box::new(args.remove(0)),
                        Box::new(args.remove(0)),
                        None,
                    ))
        ...
        if args.len() == 3 {
            match func {
                ...
                BuiltinScalarFunction::Translate => {
                    return Ok(StringFunction::Translate(
                        Box::new(args.remove(0)),
                        Box::new(args.remove(0)),
                        Box::new(args.remove(0)),
                    ))
                ...
                BuiltinScalarFunction::Replace => {
                    return Ok(StringFunction::Replace(
                        Box::new(args.remove(0)),
                        Box::new(args.remove(0)),
                        Box::new(args.remove(0)),
                    ))
                ...
                BuiltinScalarFunction::SplitPart => {
                    return Ok(StringFunction::SplitPart(
                        Box::new(args.remove(0)),
                        Box::new(args.remove(0)),
                        Box::new(args.remove(0)),
                    ))
